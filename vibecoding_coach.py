...
def main():
    ...
    .stSelectbox > div > div > select {
        background-color: rgba(255, 255, 255, 0.9) !important;  # 배경을 더 밝게
        color: #2c3e50 !important;  # 텍스트를 어두운 색으로
    ...
    /* 사이드바 모든 텍스트를 검은색으로 - Streamlit styled-components 이기기 */
    .css-1d391kg *,
    .css-1d391kg * *,
    .css-1d391kg h1,
    .css-1d391kg h2,
    ...
    .css-1d391kg [data-testid="stSidebar"] h4,
    .css-1d391kg [data-testid="stSidebar"] h5,
    .css-1d391kg [data-testid="stSidebar"] h6,
    .css-1d391kg [data-testid="stSidebar"] p,
    .css-1d391kg [data-testid="stSidebar"] div,
    .css-1d391kg [data-testid="stSidebar"] span {
        color: black !important;
    }
    
    /* 더 강력한 선택자로 Streamlit 스타일 덮어쓰기 */
    ...
    * **박지훈 구현 코치**: 실제 코드 구현과 최적화 방법 안내
    ...
    with st.sidebar:
        ...
        def validate_api_key(api_key):
            ...
            if len(api_key) < 20:
                return False, "API 키가 너무 짧습니다. 올바른 Google AI API 키를 입력해주세요."
            
            # Google AI API 키 형식 검증 (AIza로 시작하는지 확인)
            if not api_key.startswith('AIza'):
                return False, "Google AI API 키 형식이 올바르지 않습니다. 'AIza'로 시작해야 합니다."
